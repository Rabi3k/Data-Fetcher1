    ...
    public function ToLoyverseOrder(): LOrder|NULL
    {
        ...
        foreach ($this->items as $item) {
            ...
            if ($item->type == "item") {
                ...
                $lineItems[] = (object)array("variant_id" => $itemsLIds, "quantity" => intval($item->quantity), "price" => floatval($item->price));
                ...
                if (count($totalDiscounts) > 0) {
                    ...
                    $totalDiscounts[0] = (object)array("id" => $PromotionsIds, "scope" => "RECEIPT", "money_amount" => floatval($item->item_discount));
                }
            }
        }
        /*
